...
const Assets = {
	...
	Git: asset('git.png'),
	Unity: asset('unity.webp'),
	CSharp: asset('csharp.png'),
	ThreeJS: asset('threejs.png'),
	Dataport: asset('dataport.png'),
	DritterOrt: asset('dritterort.png'),
	Dominos: asset('dominos.png'),
	Elanco: asset('elanco.png'),
	Bayer: asset('bayer.png'),
	WebXR: asset('webxr.png'),
	FHWave: asset('fhwave.png'),
};
